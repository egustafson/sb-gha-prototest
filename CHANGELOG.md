...
### Added
- New matrix workflow `regression-test-matrix.yml`
- Dynamic Python matrix generation based on sb-gha-protolib `project.requires-python` minimum through configurable latest GA Python version
- Matrix workflow input reporting and per-job run context reporting

### Documentation
- Updated README with matrix workflow usage and inputs
- Updated GitHub Actions integration guide with matrix workflow examples
...
[0.1.2]: https://github.com/egustafson/sb-gha-prototest/releases/tag/v0.1.2
